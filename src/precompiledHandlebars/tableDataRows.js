...
templates['tableDataRows'] = template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
  ...
  return "<div class=\"data-container\">\r\n"
    + ((stack1 = helpers["with"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.Monthly : depth0)) != null ? stack1.Funds : stack1),{"name":"with","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "      </div>";
},"useData":true});
})();